  ...
  if (display != NULL) {
    ...
    if (resm != NULL) {
      ...
      if (xrdb != NULL) {
        ...
        XRDB_LOAD_COLOR("*color0",  col_base00);
        XRDB_LOAD_COLOR("*color1",  col_base01);
        XRDB_LOAD_COLOR("*color2",  col_base02);
        XRDB_LOAD_COLOR("*color3",  col_base03);
        XRDB_LOAD_COLOR("*color4",  col_base04);
        XRDB_LOAD_COLOR("*color5",  col_base05);
        XRDB_LOAD_COLOR("*color6",  col_base06);
        XRDB_LOAD_COLOR("*color7",  col_base07);
        XRDB_LOAD_COLOR("*color8",  col_base08);
        XRDB_LOAD_COLOR("*color9",  col_base09);
        XRDB_LOAD_COLOR("*color10", col_base10);
        XRDB_LOAD_COLOR("*color11", col_base11);
        XRDB_LOAD_COLOR("*color12", col_base12);
        XRDB_LOAD_COLOR("*color13", col_base13);
        XRDB_LOAD_COLOR("*color14", col_base14);
        XRDB_LOAD_COLOR("*color15", col_base15);
      }
    }
  }
